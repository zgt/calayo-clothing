...
export default function AdminCommissionDetails({ commission }: AdminCommissionDetailsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="rounded-lg bg-gradient-to-br from-purple-900/30 to-purple-950/80 backdrop-blur-sm p-6 shadow-2xl border border-purple-700/20"
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="flex space-x-3 self-end">
            <button
              ...
              disabled={isUpdating}
              className="inline-flex items-center px-4 py-2 rounded-lg bg-purple-700 text-white hover:bg-purple-600 disabled:opacity-50 disabled:pointer-events-none transition-colors"
            >
              {isUpdating ? (
                <>
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 rounded-lg bg-emerald-700 text-white hover:bg-emerald-600 transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 rounded-lg bg-red-700 text-white hover:bg-red-600 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" viewBox="0 0 20 20" fill="currentColor">
      ...
      >
        ...
        <div className="mb-6 p-4 bg-emerald-900/40 rounded-lg border border-emerald-700/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="text-emerald-100 font-medium font-mono text-xs">
                {commission.user_id}
              </p>
            </div>
            <div>
        ...
        <div>
          <div className="border-b border-emerald-700/30">
            <nav className="-mb-px flex space-x-8" aria-label="Tabs">
              ...
              <button
                ...
                className={`
                  whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm
                  ${activeTab === 'notes' ? 'border-emerald-500 text-emerald-400' : 'border-transparent text-emerald-300 hover:text-emerald-200 hover:border-emerald-700/50'}
                `}
              >
                Admin Notes
              </button>
          ...
          <div className={`py-6 ${activeTab === 'notes' ? 'block' : 'hidden'}`}>
            <div className="space-y-4">
              ...
              <p className="text-emerald-200/70 text-sm">Add private notes about this commission that are only visible to admins.</p>
              
              <div className="mt-2">
                <textarea
                  rows={6}
                  className="w-full rounded-lg border border-emerald-700/30 bg-emerald-900/40 p-3 text-emerald-100 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
              ...
              <div className="mt-6">
                <h4 className="font-medium text-emerald-300 mb-2">Previous Notes</h4>
                <div className="bg-emerald-900/30 rounded-lg p-4 border border-emerald-700/40">
                  <p className="text-emerald-200/70 italic">No previous notes found for this commission.</p>
                </div>
              </div>
            </div>
          </div>
