...
export default function AdminCommissionsTable({
  ...
  const [updateCommissionId, setUpdateCommissionId] = useState<string | null>(
    null,
  );
  ...
  const filteredCommissions = commissions
    .filter((commission) => filter === "all" || commission.status === filter)
    .filter((commission) => {
  ...
  const bulkUpdateStatusMutation =
    api.commissions.admin.updateStatus.useMutation();
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute(
      "download",
      `commissions_export_${new Date().toISOString().slice(0, 10)}.csv`,
    );
  ...
  const approveAllPending = async () => {
    ...
    if (
      !window.confirm(
        `Are you sure you want to approve all ${pendingCommissions.length} pending commissions?`,
      )
    ) {
      return;
    }
    ...
    const loadingToast = toast.loading(
      `Approving ${pendingCommissions.length} commissions...`,
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-emerald-700/20 bg-gradient-to-br from-emerald-900/30 to-emerald-950/80 p-6 shadow-2xl backdrop-blur-sm">
        <div className="mb-6 flex flex-col justify-between gap-4 md:flex-row">
          ...
          <div className="relative w-full md:w-1/3">
            ...
            <input
              ...
              className="w-full rounded-lg border border-emerald-700/30 bg-emerald-950/70 py-2 pr-3 pl-10 text-emerald-100 placeholder:text-emerald-600/50 focus:ring-2 focus:ring-emerald-500/30 focus:outline-none"
            />
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className={`rounded-full border px-3 py-1 text-sm ${
                filter === "Approved"
                  ? "border-blue-500/50 bg-blue-700/50 text-white"
                  : "border-emerald-700/30 bg-transparent text-emerald-300 hover:bg-emerald-800/30"
              } transition-colors`}
            >
              Approved
            ...
            <button
              ...
              className={`rounded-full border px-3 py-1 text-sm ${
                filter === "Cancelled"
                  ? "border-red-500/50 bg-red-700/50 text-white"
                  : "border-emerald-700/30 bg-transparent text-emerald-300 hover:bg-emerald-800/30"
              } transition-colors`}
            >
              Cancelled
        ...
        <div className="hidden grid-cols-12 gap-4 border-b border-emerald-700/30 px-4 py-3 text-sm font-medium text-emerald-200 md:grid">
          ...
          <div className="mt-4 space-y-4">
            {currentCommissions.map((commission, index) => (
              <motion.div
                ...
                className="rounded-lg border border-emerald-700/30 bg-emerald-900/30 p-4"
              >
                {/* Desktop view */}
                <div className="hidden grid-cols-12 items-center gap-4 md:grid">
                  ...
                  <div className="col-span-2 text-sm text-emerald-200/70">
                  ...
                  <div className="col-span-3 flex gap-2">
                    <Link
                      ...
                      className="inline-flex items-center rounded bg-emerald-800/50 px-3 py-1 text-sm text-emerald-200 transition-colors hover:bg-emerald-700/50"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button
                      ...
                      className="inline-flex items-center rounded bg-blue-800/50 px-3 py-1 text-sm text-blue-200 transition-colors hover:bg-blue-700/50"
                      disabled={
                ...
                <div className="space-y-3 md:hidden">
                  ...
                  <div className="flex flex-wrap gap-2 border-t border-emerald-700/30 pt-2">
                    <Link
                      href={`/admin/orders/${commission.id}`}
                      className="inline-flex items-center rounded bg-emerald-800/50 px-3 py-1.5 text-sm text-emerald-200 transition-colors hover:bg-emerald-700/50"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="mr-1 h-4 w-4"
                    ...
                    <button
                      onClick={() => openStatusModal(commission)}
                      className="inline-flex items-center rounded bg-blue-800/50 px-3 py-1.5 text-sm text-blue-200 transition-colors hover:bg-blue-700/50"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="mr-1 h-4 w-4"
        ...
        {/* Pagination */}
        {filteredCommissions.length > 0 && (
          <div className="mt-6 flex items-center justify-between border-t border-emerald-700/30 pt-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="inline-flex items-center rounded bg-emerald-900/50 px-3 py-1 text-sm text-emerald-200 transition-colors hover:bg-emerald-800/50 disabled:pointer-events-none disabled:opacity-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-1 h-4 w-4"
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="rounded border border-emerald-700/30 bg-emerald-900/50 px-2 py-1 text-sm text-emerald-200"
              >
      ...
      {/* Admin Actions Panel */}
      <div className="rounded-lg border border-purple-700/20 bg-gradient-to-br from-purple-900/30 to-purple-950/80 p-6 shadow-2xl backdrop-blur-sm">
        <h2 className="mb-4 text-xl font-bold text-white">Admin Actions</h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div className="rounded-lg border border-purple-700/30 bg-purple-900/30 p-4">
            ...
            <div className="space-y-3">
              <button
                onClick={exportToCSV}
                className="inline-flex w-full items-center justify-center rounded-md bg-purple-800/70 px-4 py-2 text-purple-100 transition-colors hover:bg-purple-700/70"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button className="inline-flex w-full items-center justify-center rounded-md bg-purple-800/70 px-4 py-2 text-purple-100 transition-colors hover:bg-purple-700/70">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-5 w-5"
                  viewBox="0 0 20 20"
          ...
          <div className="rounded-lg border border-purple-700/30 bg-purple-900/30 p-4">
            ...
            <div className="space-y-3">
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-md bg-blue-800/70 px-4 py-2 text-blue-100 transition-colors hover:bg-blue-700/70"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-5 w-5"
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center rounded-md bg-emerald-800/70 px-4 py-2 text-emerald-100 transition-colors hover:bg-emerald-700/70"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="mr-2 h-5 w-5"
      ...
      {showStatusModal && selectedCommission && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          ></div>
          <div className="relative mx-4 w-full max-w-md rounded-lg border border-emerald-700/30 bg-gradient-to-br from-emerald-900/90 to-emerald-950/90 p-6 shadow-2xl backdrop-blur-sm">
            <button
              onClick={closeStatusModal}
            ...
            <div className="mb-4">
              ...
              <p className="text-emerald-200">
                ...
                <span
                  className={`ml-2 inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium ${getStatusBadge(selectedCommission.status)}`}
                >
            ...
            <div className="mb-6">
              ...
              <select
                ...
                className="w-full rounded-lg border border-emerald-700/30 bg-emerald-900/70 px-3 py-2 text-emerald-100 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none"
              >
            ...
            <div className="flex justify-end gap-3">
              <button
                onClick={closeStatusModal}
                className="rounded-lg border border-emerald-700/30 px-4 py-2 text-emerald-200 hover:bg-emerald-900/50"
              >
                Cancel
              </button>
              <button
                ...
                className="inline-flex items-center rounded-lg bg-emerald-700 px-4 py-2 text-white hover:bg-emerald-600 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {isUpdating ? (
                  <>
                    <svg
