...
export default function MeasurementGuide() {
  return (
    <div className="rounded-lg border border-emerald-700/20 bg-gradient-to-br from-emerald-900/30 to-emerald-950/80 p-6 shadow-2xl backdrop-blur-sm">
      ...
      <div className="mt-6 rounded-md border border-emerald-700/30 bg-emerald-900/50 p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-emerald-200/70">
              <ul className="list-disc space-y-1 pl-5">
                ...
                <li>
                  Take multiple measurements for crucial areas to ensure
                  accuracy
                </li>
                <li>
