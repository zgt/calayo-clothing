...
import {
  MEASUREMENT_GUIDE_ITEMS,
  MEASUREMENT_TIPS,
} from "../measurementGuideData";
...
export function MeasurementGuideDisplay({
  ...
  if (!currentMeasurement) {
    return (
      <div
        className={`rounded-2xl border border-emerald-700/10 bg-gradient-to-br from-emerald-900/20 to-emerald-950/30 p-6 shadow-2xl backdrop-blur-xs ${className}`}
      >
      ...
      <div className="space-y-4">
        ...
        <HoverCard>
          <HoverCardTrigger asChild>
            <div className="cursor-pointer rounded-md border border-emerald-700/30 bg-emerald-900/50 p-4 transition-colors hover:bg-emerald-900/60">
              <div className="flex">
          ...
          <HoverCardContent
            className="w-80 border-emerald-700/50 bg-emerald-900/95 backdrop-blur-sm"
            side="right"
            sideOffset={10}
          >
