...
export default function About() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-emerald-950 to-gray-950 py-16 px-4 sm:px-6">
      <motion.div
      ...
      >
        <div className="bg-gradient-to-br from-emerald-900/30 to-emerald-950/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-emerald-700/20">
          ...
          <div className="prose prose-emerald prose-invert max-w-none">
            <p className="text-emerald-100/90 mb-6 leading-relaxed">
              I&apos;m a software developer with over 4 years of full stack experience, specializing in JavaScript and Java applications. 
              My technical expertise lies in modern JavaScript frameworks - I built this website using React, Next.js, and Supabase, 
              after previously creating a version with Solidjs, Solidstart, and MongoDB. I offer a strong background in creative problem-solving 
          ...
          <div className="mt-12 border-t border-emerald-700/30 pt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-lg font-semibold text-emerald-400 mb-3">Development</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-emerald-400 mb-3">Design</h3>
                <ul className="space-y-2">
                  <li className="flex items-center text-emerald-100/90">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-emerald-500 mr-2" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          <div className="mt-12 text-center">
            <a 
              href="/commissions" 
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-medium rounded-lg shadow-lg shadow-emerald-900/30 transition-all duration-200 hover:shadow-emerald-800/40"
            >
