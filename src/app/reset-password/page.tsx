          ...
          <div className="px-8 py-6 text-center">
            ...
            <div className="space-y-4">
              <Link
                ...
                className="inline-flex justify-center rounded-md bg-gradient-to-r from-emerald-500 to-teal-600 py-2 px-4 text-sm font-semibold text-white hover:from-emerald-600 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-colors duration-200"
              >
