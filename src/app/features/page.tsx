    ...
    <main className="min-h-screen pt-6 pb-12">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          className="mx-auto max-w-7xl rounded-lg border border-emerald-700/20 bg-gradient-to-br from-emerald-900/30 to-emerald-950/80 p-6 shadow-2xl backdrop-blur-sm"
        >
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      <svg
        ...
        className="mb-4 h-16 w-16 text-emerald-500/40"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
      ...
      <p className="max-w-md text-emerald-200/70">
        This feature is currently under development. Check back soon for
        exciting new content!
      </p>
      <Link
        href="/"
        className="mt-6 inline-flex items-center rounded-lg bg-emerald-700/50 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-emerald-600/50"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
